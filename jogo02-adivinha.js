...
if (modo === 1) {
    ...
    console.log(`Você tem ${MAX_TENTATIVAS} tentativas.`);
    ...
    for (let i = 1; i <= MAX_TENTATIVAS; i++) {
        ...
        let entrada = lerTeclado.questionInt(`Tentativa ${i}: `);
        let palpite = entrada;
    ...
    console.log(`Tentativas usadas: ${acertou ? "até " + MAX_TENTATIVAS : MAX_TENTATIVAS}`);
